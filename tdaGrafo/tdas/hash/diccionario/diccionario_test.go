...
func igualesString(a, b string) bool {
	return a == b
}
...
func TestDiccionarioVacio(t *testing.T) {
	...
	dic := TDADiccionario.CrearHash[string, string](igualesString)
...
func TestDiccionarioClaveDefault(t *testing.T) {
	...
	dicNum := TDADiccionario.CrearHash[int, string](igualesInt)
...
func TestUnElement(t *testing.T) {
	...
	dic := TDADiccionario.CrearHash[string, int](igualesString)
	dic.Guardar("A", 10)
...
func TestReemplazoDatoHopscotch(t *testing.T) {
	...
	dic := TDADiccionario.CrearHash[int, int](igualesInt)
	for i := 0; i < 500; i++ {
		dic.Guardar(i, i)
	}
	for i := 0; i < 500; i++ {
...
func TestConClavesNumericas(t *testing.T) {
	...
	dic := TDADiccionario.CrearHash[int, string](igualesInt)
	clave := 10
	valor := "Gatito"
